...
export const MacbookScroll = ({
  ...
  // FuseOS: 1500 carried the lid past the section's end, where the next section cut it off.
  ...
  return (
    ...
    >
      ...
      <div className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-gray-200 dark:bg-[#272729]">
        ...
        {showGradient && (
          <div className="absolute inset-x-0 bottom-0 z-50 h-40 w-full bg-gradient-to-t from-[#07080C] via-[#07080C] to-transparent"></div>
        )}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        {/* FuseOS: a live screen instead of a screenshot. */}
